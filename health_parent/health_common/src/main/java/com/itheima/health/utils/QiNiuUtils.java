...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "nL6TZWEg35RWG2X52f0RcHzLIelWSyLo1sON5nO1";
    private static final String SECRETKEY = "P4ji7V8UBr8PJJvuuVa37OCM_JsdUHGP4B9L3qqJ";
    private static final String BUCKET = "health102";
    public static final String DOMAIN= "http://qiqi9x3ov.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        //uploadFile("D:\\stduy\\mn.jpg","mn.jpg");
